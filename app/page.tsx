...
export default async function Index() {
  ...
  return (
    <>
      <Alert>
        <TriangleAlert />
        <AlertTitle className="ml-4">Project Currently Closed</AlertTitle>
        <AlertDescription className="ml-4">
          Due to high EC2 bills, this project is currently closed and signup is
          disabled. To see how this was built, please check out my{" "}
          <ExternalLink href="https://vinayaknigam.hashnode.dev/learn-bash-cmd-using-ai-and-web-based-terminal">
            blog
          </ExternalLink>{" "}
          post
        </AlertDescription>
              ...
              <div className="flex flex-col items-center justify-center space-y-4 text-center">
                <div className="space-y-2">
                  ...
                  <p className="max-w-[900px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                    Our AI-powered application provides a live practice
                    terminal, and a knowledgeable chatbot to help you master
                    terminal commands.
                  </p>
                </div>
              </div>
              <div className="mx-auto grid max-w-5xl items-center gap-6 py-12 lg:grid-cols-2 lg:gap-12">
                <div className="flex flex-col justify-center space-y-4">
                  <div className="grid gap-1">
                    ...
                    <p className="text-muted-foreground">
                      Your terminal is isolated so even if you mess up
                      something, you can just restart the terminal and it will
                      be a new machine
                    </p>
                  </div>
                  <div className="grid gap-1">
                    <h3 className="text-xl font-bold">
                      Live Practice Terminal
                    </h3>
                    <p className="text-muted-foreground">
                      Reinforce your learning by practicing terminal commands in
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground text-center mt-2">
                    Can't see the video?{" "}
                    <Link
                      href="https://x.com/louremipsum/status/1822144923799372035"
                      target="_blank"
